...
CREATE TABLE `satellite` (
  `satelliteId` int unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `satellite` VALUES (1,'Moon',1500,30000,1),(2,'Deimos',1000,35000,2),(3,'Fobos',2000,10000,2),(4,'Callisto',1000,8000,19),(5,'Elara',1500,10000,19),(6,'Mimas',2000,10000,20),(7,'Janus',800,10000,20);
...
-- Dump completed on 2021-07-30  4:28:45
